...
class account_fstr_category(osv.osv):
    ...
    _columns = {
        ...
        'progenitor_name': fields.function(_get_progenitor_id, method=True, string='Progenitor', type='char',size=128, store={ 'account_fstr.category': (_get_childs, ['parent_id'], 1)}, multi=True),
