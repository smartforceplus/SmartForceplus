...
class aged_trial_report_ept(report_sxw.rml_parse, common_report_header):

    def __init__(self, cr, uid, name, context):
        super(aged_trial_report_ept, self).__init__(cr, uid, name, context=context)
        self.total_account = []
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(aged_trial_report_ept, self).set_context(objects, data, ids, report_type=report_type)
...
report_sxw.report_sxw('report.Aged Partner Balance', 'res.partner',
        'addons/accounts_reports_ept/reports/aged_partner_balance.mako',parser=aged_trial_report_ept, header="internal landscape")
