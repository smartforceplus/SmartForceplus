...
class crm_lead(format_address, osv.osv):
    ...
    _columns = {
        ...
        'website': fields.char('website', required=True, select=1),
    ...
    def convert_opportunity(self, cr, uid, ids, partner_id, user_ids=False, section_id=False, context=None):
        ...
        return True
#this stuff here Anthony from TAGSBM
    def _lead_create_contact(self, cr, uid, lead, name, is_company, parent_id=False, context=None):
        _logger.info('createcontacttttttttttttttttttttttttttttttttttttttttttttttttttttt %s',lead.id)
        partner = self.pool.get('res.partner')
        vals = {'name': lead.contact_name,
            'name_c': lead.partner_name,
            'contact_name': lead.contact_name,
            'user_id': lead.user_id.id,
            'user_id_n': lead.user_id.id,
            ...
            'mobile_num': lead.mobile,
            'email_form': tools.email_split(lead.email_from) and tools.email_split(lead.email_from)[0] or False,
            'fax_num': lead.fax,
            'street_n': lead.street,
            'street2_n': lead.street2,
            'zip_n': lead.zip,
            'TagCust1':lead.TagCust1,
            'TagCust2':lead.TagCust2,
            'TagCust3':lead.TagCust3,
            'TagCust4':lead.TagCust4,
            'TagCust5':lead.TagCust5,
			'TagCust6':lead.TagCust6,
            'TagCust7':lead.TagCust7,
            'TagCust8':lead.TagCust8,
            'TagCust9':lead.TagCust9,
            'TagCust10':lead.TagCust10,
			'TagCust11':lead.TagCust11,
            'TagCust12':lead.TagCust12,
            'TagCust13':lead.TagCust13,
            'TagCust14':lead.TagCust14,
            'TagCust15':lead.TagCust15,
			'TagCust16':lead.TagCust16,
            'TagCust17':lead.TagCust17,
            'TagCust18':lead.TagCust18,
            'TagCust19':lead.TagCust19,
            'TagCust20':lead.TagCust20,
			'TagCust21':lead.TagCust21,
            'TagCust22':lead.TagCust22,
            'TagCust23':lead.TagCust23,
            'TagCust24':lead.TagCust24,
            'TagCust25':lead.TagCust25,
			'TagCust26':lead.TagCust26,
            'TagCust27':lead.TagCust27,
            'TagCust28':lead.TagCust28,
            'TagCust29':lead.TagCust29,
            'TagCust30':lead.TagCust30,
			'TagCust31':lead.TagCust31,
            'TagCust32':lead.TagCust32,
            'TagCust33':lead.TagCust33,
            'TagCust34':lead.TagCust34,
            'TagCust35':lead.TagCust35,
			'TagCust36':lead.TagCust36,
            'TagCust37':lead.TagCust37,
            'TagCust38':lead.TagCust38,
            'TagCust39':lead.TagCust39,
            'TagCust40':lead.TagCust40,
			'TagCust41':lead.TagCust41,
            'TagCust42':lead.TagCust42,
            'TagCust43':lead.TagCust43,
            'TagCust44':lead.TagCust44,
            'TagCust45':lead.TagCust45,
			'TagCust46':lead.TagCust46,
            'TagCust47':lead.TagCust47,
            'TagCust48':lead.TagCust48,
            'TagCust49':lead.TagCust49,
            'TagCust50':lead.TagCust50,
			#<--Cust Fields above-->
			
			#<--Cust List Fields below-->
			'TagCustAL1':lead.TagCustAL1,
			'TagCustAL2':lead.TagCustAL2,
			'TagCustAL3':lead.TagCustAL3,
			'TagCustAL4':lead.TagCustAL4,
			'TagCustAL5':lead.TagCustAL5,
			'TagCustAL6':lead.TagCustAL6,
			'TagCustAL7':lead.TagCustAL7,
			'TagCustAL8':lead.TagCustAL8,
			'TagCustAL9':lead.TagCustAL9,
			'TagCustAL10':lead.TagCustAL10,
			'TagCustAL11':lead.TagCustAL11,
			'TagCustAL12':lead.TagCustAL12,
			'TagCustAL13':lead.TagCustAL13,
			'TagCustAL14':lead.TagCustAL14,
			'TagCustAL15':lead.TagCustAL15,
			'TagCustAL16':lead.TagCustAL16,
#			'TagCustAL20':lead.TagCustAL20,
			'TagCustAL21':lead.TagCustAL21,
			'TagCustAL22':lead.TagCustAL22,
			'TagCustAL23':lead.TagCustAL23,
			'TagCustAL24':lead.TagCustAL24,
			'TagCustAL25':lead.TagCustAL25,
			'TagCustAL26':lead.TagCustAL26,
			'TagCustAL27':lead.TagCustAL27,
			'TagCustAL28':lead.TagCustAL28,
			'TagCustAL29':lead.TagCustAL29,
			'TagCustAL30':lead.TagCustAL30,
			'TagCustAL31':lead.TagCustAL31,
			'TagCustAL32':lead.TagCustAL32,
			'TagCustAL33':lead.TagCustAL33,
			'TagCustAL34':lead.TagCustAL34,
			'TagCustAL35':lead.TagCustAL35,
			'TagCustAL36':lead.TagCustAL36,
			
			#List ID
			'TagCustList01':lead.TagCustList01,
        ...
        _logger.info('valssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss %s',vals)
        partner = partner.create(cr, uid, vals, context=context)
        _logger.info('partnerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr %s',partner,lead.contact_name)
        return partner

#this was test field'HairColour': lead.HairColour,
