...
class Skill(models.Model):
    ...
    documentation_link = fields.Char(string="Training Documentation")
    ...
    employee_comp = fields.One2many('hr.skill.comp','skill_id', string="Employees")
...
class SkillComp(models.Model):
    ...
    comp = fields.Selection((('A','A'),('B','B'),('C','C'),('D','D'),('E','E')),string="Competency Level")