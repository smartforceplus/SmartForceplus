...
class contactus(http.Controller):
    ...
    def contact(self, **kwargs):
        values = {}
        for field in ['description', 'partner_name', 'phone', 'contact_name', 'email_from', 'name','mobile','state_id','zip','referred','medium_id']:
            if kwargs.get(field):
    ...
    def contactus(self, **kwargs):
        ...
        _REQUIRED = ['name', 'email']  # Could be improved including required from model
